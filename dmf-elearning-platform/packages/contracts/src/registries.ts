...
import {
  learningLessonStartSchema,
  learningLessonCompleteSchema,
  learningLessonAbandonSchema,
  learningActivitySubmitSchema,
} from './commands/learning.js';
import {
  assessmentQuizStartSchema,
  assessmentQuizSubmitSchema,
  assessmentPlacementTakeSchema,
} from './commands/assessment.js';
import {
  mentoringFeedbackRequestSchema,
  mentoringFeedbackPublishSchema,
} from './commands/mentoring.js';
import {
  curriculumCourseEnrollSchema,
  curriculumUnitAccessSchema,
} from './commands/curriculum.js';
import {
  systemUserRegisterSchema,
  systemUserLoginSchema,
  systemProfileModifySchema,
  systemSrsScheduleSchema,
} from './commands/system.js';
import {
  evidenceReviewClaimSchema,
  evidenceReviewApproveSchema,
  evidenceReviewRejectSchema,
} from './commands/evidence.js';
import {
  policyHardGateSetSchema,
  policyHardGateBulkSetSchema,
} from './commands/policy.js';

// Import all event schemas
import {
  learningLessonStartedSchema,
  learningLessonCompletedSchema,
  learningLessonAbandonedSchema,
  learningSubmissionCreatedSchema,
} from './events/learning.js';
import {
  assessmentQuizStartedSchema,
  assessmentQuizSubmittedSchema,
  assessmentLevelTestCompletedSchema,
} from './events/assessment.js';
import {
  mentoringFeedbackRequestedSchema,
  mentoringFeedbackPublishedSchema,
} from './events/mentoring.js';
import {
  curriculumCourseEnrolledSchema,
  curriculumUnitUnlockedSchema,
  curriculumSrsItemsDueSchema,
} from './events/curriculum.js';
import {
  systemUserRegisteredSchema,
  systemUserLoginSchema as systemUserLoginEventSchema,
  systemProfileUpdatedSchema,
} from './events/system.js';
import {
  opsPolicyCreatedSchema,
  opsPolicyActivatedSchema,
  opsResourceRolledBackSchema,
  opsRbacDiffViewedSchema,
  policyHardGateUpdatedSchema,
  opsOverloadDetectedSchema,
  opsDegradeActivatedSchema,
  opsDegradeDeactivatedSchema,
} from './events/ops.js';
import {
  evidenceCreatedSchema,
  evidenceValidatedSchema,
  evidenceRevokedSchema,
  evidenceSoftGateTriggeredSchema,
  evidenceHardGateBlockedSchema,
  evidencePolicyViolationDetectedSchema,
  evidenceReviewApprovedSchema,
  evidenceReviewRejectedSchema,
  evidenceReviewExpiredSchema,
  evidenceReviewEscalatedSchema,
 ...
 */
export const commandRegistry: Record<string, ZodSchema> = {
  // Learning commands
 ...
 */
export const eventRegistry: Record<string, ZodSchema> = {
  // Learning events
