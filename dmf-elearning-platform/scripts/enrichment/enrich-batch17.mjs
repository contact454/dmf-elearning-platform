#!/usr/bin/env node
/**
 * Enrich Batch 17 Vocabulary with Examples
 */
...
const BATCH_SIZE = 20;
const INPUT = path.resolve(__dirname, '../data/quality-expansion/batch17-vocabulary.json');
const OUTPUT = path.resolve(__dirname, '../data/quality-expansion/enriched-batch17.json');
const PROGRESS = path.resolve(__dirname, '../data/quality-expansion/enrich-batch17-progress.json');
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║    📝 ENRICH BATCH 17 VOCABULARY (420 words)               ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
