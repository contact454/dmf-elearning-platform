#!/usr/bin/env node
/**
 * Enrich Curated Vocabulary with Example Sentences
...
const BATCH_SIZE = 15;
const INPUT_FILE = path.resolve(__dirname, '../data/curation/final/curated-vocabulary.json');
const OUTPUT_FILE = path.resolve(__dirname, '../data/curation/final/enriched-vocabulary.json');
const PROGRESS_FILE = path.resolve(__dirname, '../data/curation/final/enrichment-progress.json');
...
async function enrichVocabulary() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║    📝 ENRICH VOCABULARY WITH EXAMPLES                      ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
  ...
  console.log(`📥 Loaded ${allWords.length} curated words\n`);
