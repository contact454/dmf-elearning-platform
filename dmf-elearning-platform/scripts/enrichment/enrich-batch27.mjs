#!/usr/bin/env node
/**
 * Enrich Batch 27 Vocabulary with Examples
 */
...
const BATCH_SIZE = 20;
const INPUT = path.resolve(__dirname, '../data/quality-expansion/batch27-vocabulary.json');
const OUTPUT = path.resolve(__dirname, '../data/quality-expansion/enriched-batch27.json');
const PROGRESS = path.resolve(__dirname, '../data/quality-expansion/enrich-batch27-progress.json');
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║    📝 ENRICH BATCH 27 VOCABULARY                           ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
