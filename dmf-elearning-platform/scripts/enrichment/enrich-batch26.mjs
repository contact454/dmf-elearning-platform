#!/usr/bin/env node
/**
 * Enrich Batch 26 Vocabulary with Examples
 */
...
const BATCH_SIZE = 20;
const INPUT = path.resolve(__dirname, '../data/quality-expansion/batch26-vocabulary.json');
const OUTPUT = path.resolve(__dirname, '../data/quality-expansion/enriched-batch26.json');
const PROGRESS = path.resolve(__dirname, '../data/quality-expansion/enrich-batch26-progress.json');
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║    📝 ENRICH BATCH 26 VOCABULARY                           ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
