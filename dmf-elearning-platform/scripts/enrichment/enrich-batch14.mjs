#!/usr/bin/env node
/**
 * Enrich Batch 14 Vocabulary with Examples
 */
...
const BATCH_SIZE = 20;
const INPUT = path.resolve(__dirname, '../data/quality-expansion/batch14-vocabulary.json');
const OUTPUT = path.resolve(__dirname, '../data/quality-expansion/enriched-batch14.json');
const PROGRESS = path.resolve(__dirname, '../data/quality-expansion/enrich-batch14-progress.json');
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║    📝 ENRICH BATCH 14 VOCABULARY (360 words)               ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
