#!/usr/bin/env node
/**
 * Seed Enriched Vocabulary to Database
 * Imports enriched-vocabulary.json into existing Vocabulary table
 */
...
const INPUT_FILE = path.join(__dirname, 'data/curation/final/enriched-vocabulary.json');
...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║    🌱 SEED ENRICHED VOCABULARY TO DATABASE                  ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
