...
import { createInMemoryMasteryRepository } from '../services/motivation-progress-service/src/state/in-memory-mastery.repository';
import { createInMemorySkillScoreRepository } from '../services/motivation-progress-service/src/state/in-memory-skillscore.repository';
import { setupEventConsumers } from '../services/motivation-progress-service/src/events/consumers/index';
import { registerMasteryReadRoute } from '../services/motivation-progress-service/src/http/queries/mastery.read.route';
...
async function runApiSmokeTest() {
    console.log('🚀 Starting M3-lite API Smoke Test...');
